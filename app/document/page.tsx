...
export default async function DocumentPage({ searchParams }: PageProps) {
  ...
  return <DocumentViewer documentUrl={validation.documentUrl!} documentId={documentId} userId={userId} apiKey={apiKey} documentStatus={validation.documentStatus ?? 'pending'} />;
}