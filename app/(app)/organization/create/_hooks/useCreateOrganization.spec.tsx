...
describe('useCreateOrganization', () => {
  ...
  it('al éxito: inserta la cuenta en accountsList, la vuelve activa, muestra el toast y redirige a /documents/create', async () => {
    ...
    expect(push).toHaveBeenCalledWith('/documents/create');
  });
